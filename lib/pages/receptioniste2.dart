...
class Receptioniste2 extends StatefulWidget {
  const Receptioniste2({super.key});

  @override
  State<Receptioniste2> createState() => _Receptioniste2State();
}

class _Receptioniste2State extends State<Receptioniste2> {
  List<dynamic> users = [];
  ...
  void fetchUsers() async {
    ...
    const url = 'http://192.168.2.165:8080/api/Queue1/vservice2';
  ...
  void moveToNext() async {
    final url = Uri.parse('http://192.168.2.165:8080/api/Queue1/next2');
